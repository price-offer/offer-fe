...
const ProfileBox = ({
  ...
  reviewCount,
  className
}: Partial<ProfileBoxProps>): ReactElement => {
  const isMyProfile = typeof likeProductCount === 'number'
  ...
  return (
    <Styled.Container className={className}>
      ...
      <Styled.ProfileWrapper>
        ...
        <Styled.UserProductWrapper isMyProfile={isMyProfile}>
